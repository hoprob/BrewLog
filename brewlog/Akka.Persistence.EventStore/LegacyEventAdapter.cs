...
/// <summary>
/// Preserves behavior pre-1.4. This adapter does not deal with complex messages that has 
/// Akka internals such as ActorRefs.
/// Actor
/// </summary>
public class LegacyEventAdapter : IEventAdapter
{
    private readonly Akka.Serialization.Serialization _serialization;
    private readonly JsonSerializerSettings _settings;

    public LegacyEventAdapter(Akka.Serialization.Serialization serialization)
    {
    ...
    public EventData Adapt(IPersistentRepresentation persistentMessage)
    {
        ...
        metadata[Constants.EventMetadata.SenderPath] =
            persistentMessage.Sender?.Path?.ToStringWithoutAddress() ?? string.Empty;
